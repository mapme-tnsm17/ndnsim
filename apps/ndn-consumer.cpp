...
#ifdef BUGFIXES
      .AddAttribute("MaxRTO", "Max RTO", StringValue("0s"),
                    MakeTimeAccessor(&Consumer::m_MaxRTO), MakeTimeChecker())
#endif // BUGFIXES
...
#ifdef BUGFIXES
  , m_MaxRTO(Seconds(0)) //no maxRTO set
#endif // BUGFIXES
{
...
#ifdef BUGFIXES
  if (rto > m_MaxRTO && m_MaxRTO!=Seconds(0)){
    rto = m_MaxRTO;
  }
#endif // BUGFIXES

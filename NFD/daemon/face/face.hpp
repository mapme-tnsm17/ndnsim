...
// ---------------------Natalya
  void
   ...
   bool
   GetWirelessFace() const
   {
 	  return m_isWirelessFace;
   }  
   ...
   IsStaAllowed()
   {
           return this->m_SpecificSta;
   }

   void
   SetCallbackUp(ns3::Callback<void, Face&> cb);

   void
   SetCallbackDown(ns3::Callback<void, Face&> cb);
//#endif
// ---------------------Natalya
...
//---------------------Natalya
  bool m_isWirelessFace;
  bool m_SignalFace;
  bool m_SpecificSta; // to allow specific STA operations like reassociation messages
  bool m_up;
/*
  ns3::Callback<void, Face&> m_cbFaceUp;
  ns3::Callback<void, Face&> m_cbFaceDown;
  bool m_cbUpIsSet;
  bool m_cbDownIsSet;
*/
//#endif

...
{
  m_up = val;
/*  if(val == true && m_cbUpIsSet)
    this->m_cbFaceUp(*this);
  else if(val == false && m_cbDownIsSet)
    this->m_cbFaceDown(*this);*/
}
...
/*
void
Face::SetCallbackUp(ns3::Callback<void, Face&> cb)
{
        m_cbFaceUp = cb;
        this->m_cbUpIsSet = true;
}

void
Face::SetCallbackDown(ns3::Callback<void, Face&> cb)
{
        m_cbFaceDown = cb;
        this->m_cbDownIsSet = true;
}
*/
//---------
...
{
        m_isWirelessFace = true;
}

void
Face::SetFaceAsSignal()
{
        m_SignalFace = true;
}

void
Face::AllowStaOperations()
{
        this->m_SpecificSta = true;
}

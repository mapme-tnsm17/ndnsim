...
//TFIB////for tfib*****************
//TFIB//void
//TFIB//Entry::setTmpFibEntry(shared_ptr<fib::TmpEntry> tmpFibEntry)
//TFIB//{
//TFIB//  if (static_cast<bool>(tmpFibEntry)) {
//TFIB//    BOOST_ASSERT(!static_cast<bool>(tmpFibEntry->m_nameTreeEntry));
//TFIB//  }
//TFIB//
//TFIB//  if (static_cast<bool>(m_tmpFibEntry)) {
//TFIB//    m_tmpFibEntry->m_nameTreeEntry.reset();
//TFIB//  }
//TFIB//  m_tmpFibEntry = tmpFibEntry;
//TFIB//  if (static_cast<bool>(m_tmpFibEntry)) {
//TFIB//    m_tmpFibEntry->m_nameTreeEntry = this->shared_from_this();
//TFIB//  }
//TFIB//}
//TFIB//#endif // MAPME

...
void
Fib::_onUpdate(shared_ptr<fib::Entry> fibEntry)
{
  this->onUpdate(fibEntry);
}
...
{
#ifdef FIB_EXTENSIONS
  this->onRemove(nameTreeEntry->getFibEntry());
#endif // FIB_EXTENSIONS
...
void
#ifdef FIB_EXTENSIONS
Fib::removeNextHopFromAllEntries(shared_ptr<Face> face, bool clear_empty)
#else
...
#endif // FIB_EXTENSIONS
{
  ...
  // We maintain empty next hop list to mark the end for IU 
#ifdef FIB_EXTENSIONS
  if (!clear_empty)
    return;
#endif // FIB_EXTENSIONS

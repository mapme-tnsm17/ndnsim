...
//TFIB//#ifdef MAPME
//TFIB//  //for tfib********************
//TFIB//  //get NameTree entry from attached TFIB entrty
//TFIB//  shared_ptr<name_tree::Entry>
//TFIB//  get(const fib::TmpEntry& tmpFibEntry) const;
//TFIB//#endif // MAPME
...
//TFIB//#ifdef MAPME
//TFIB//inline shared_ptr<name_tree::Entry>
//TFIB//NameTree::get(const fib::TmpEntry& tmpFibEntry) const
//TFIB//{
//TFIB//  return tmpFibEntry.m_nameTreeEntry;
//TFIB//}
//TFIB//#endif

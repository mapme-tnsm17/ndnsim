...
#ifdef NDN_CXX_MAPME
  //new field type:
  SpecialInterestType	= 33,
  SequenceNumber	= 34,
#endif // NDN_CXX_MAPME

#ifndef NDNSIM
#ifdef NDN_CXX_HOP_COUNT
  // Used outside of ndnSIM to count the number of hops traversed by the data packet.
  // In ndnSIM, this is ensured by the hopCount packet tag.
  HopCount      = 36,
...
#ifdef NDN_CXX_KITE
  //new optinal field type for kite:
  TraceForwardingFlag = 77,
  TraceName     = 78,
#endif // NDN_CXX_KITE
